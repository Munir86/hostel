        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">تعديل تفاصيل الغرفة</h4>
                     ...
                     //$cnt=1;
                       while($row=$res->fetch_object())
                      {
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">عداد الاشخاص في الغرفة</h4>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title">الاجر الشهري </h4>
                                        <div class="form-group">
